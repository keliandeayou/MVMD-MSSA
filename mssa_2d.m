...
% SVD deconcoposition with P largest singular values of Randomized SVD 这里的3000就是窗口长度
   %if meth==1;   [U,S,V] = svds(M,1); Mout = U*S*V; end;
   if meth==1;    [U,S,V] = svds(M,1258); Mout = U(:,1:P)*S(1:P,1:P)*V(:,1:P)'; end 
